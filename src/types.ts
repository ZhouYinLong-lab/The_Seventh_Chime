...
export type PlaytestEventKind = 'query' | 'invalid_query' | 'unlock' | 'revisit' | 'compare' | 'hint' | 'b4_reveal' | 'hypothesis_edit' | 'ring_submit' | 'modified_frame_reveal' | 'modified_frame_edit' | 'modified_frame_submit' | 'terminal_command' | 'b7_alignment_submit';
...
export interface SaveV4 extends Omit<SaveV3, 'version'> { version: 4; terminalLog: TerminalEntry[]; b7AlignmentDraft: Record<string, string>; b7Alignment: B7Alignment | null }
