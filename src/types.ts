...
export type PlaytestEventKind = 'query' | 'invalid_query' | 'unlock' | 'revisit' | 'compare' | 'hint' | 'b4_reveal' | 'hypothesis_edit' | 'ring_submit' | 'modified_frame_reveal' | 'modified_frame_edit' | 'modified_frame_submit' | 'terminal_command';
...
export interface SaveV4 extends Omit<SaveV3, 'version'> { version: 4; terminalLog: TerminalEntry[] }
